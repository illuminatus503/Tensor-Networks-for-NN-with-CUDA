...
{
    TQ_Matrix *matrix = TQ_emptymat(TQ_newtuple((long[]){2, 1}, 2, TQ_LONG), // inline init of a tuple
                                    TQ_FLOAT);
    ...
    matrix = TQ_newmatrix((double[]){3.141592, 2.718281, 2.718281, 3.141592}, // inline init of an array
                          TQ_newtuple((long[]){2, 2}, 2, TQ_LONG),            // inline init of a tuple: shape
                          TQ_DOUBLE);
    ...
    matrix = TQ_newmatrix((double[]){3.141592, 2.718281, 2.718281, 3.141592, 3.141592, 2.718281, 2.718281, 3.141592}, // inline init of an array
                          TQ_newtuple((long[]){2, 2, 2}, 3, TQ_LONG),                                                 // inline init of a tuple: shape
                          TQ_DOUBLE);
    printf("Creamos una matriz a partir de un vector plano:\n");
    TQ_print_matrix(matrix);
    ...
    matrix = TQ_newmatrix((double[]){3.141592, 2.718281},             // inline init of an array
                          TQ_newtuple((long[]){1, 2, 1}, 3, TQ_LONG), // inline init of a tuple: shape
                          TQ_DOUBLE);
    printf("Creamos una matriz a partir de un vector plano:\n");
    TQ_print_matrix(matrix);
